...
var InkBar = require('../ordertype-ink-bar');
...
var InvertTabs = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { style: this.mergeAndPrefix({position:"fixed", bottom: "4px"},styles.tabItemContainer, this.props.tabItemContainerStyle) },
        tabs
      ),
      React.createElement(
        'div',
        { style: {position: 'fixed', backgroundColor: '#35acef'}},
        React.createElement(InkBar, {left: "0px", width: '100%'})
      )
