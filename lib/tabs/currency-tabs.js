...
var CurrencyTabs = React.createClass({
  displayName: 'CurrencyTabs',
  ...
  render: function render() {
    ...
    var tabs = React.Children.map(this.props.children, function (tab, index) {
      if (tab.type.displayName === 'Tab' || tab.type.displayName === 'ITab') {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        {style: {textAlign:'center', paddingLeft: '8px', paddingRight: '10px', backgroundColor: '#cceafb'}},
