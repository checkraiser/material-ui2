...
var InkBar = require('../footer-ink-bar');
var StylePropable = require('../mixins/style-propable.js');
var Events = require('../utils/events');

var FooterTabs = React.createClass({
  ...
  onChangeUrl: function onChangeUrl(tabIndex){
  ...
  //  var tmpLeft =  width  + '*' + this.state.selectedIndex;
    var left = 'calc(16%)';
    ...
    var tabs = React.Children.map(this.props.children, function (tab, index) {
      if (tab.type.displayName === 'FooterTab') {
        ...
        throw 'Tabs only accepts FooterTab Components as children. Found ' + type + ' as child number ' + (index + 1) + ' of Tabs';
      }
    }, this);
