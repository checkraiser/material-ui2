...
module.exports = {
  ...
  ITab: require('./tabs/itab'),
  Tab: require('./tabs/tab'),
  Tabs: require('./tabs/tabs'),
  InvertTabs: require('./tabs/invert-tabs'),
  CurrencyTabs: require('./tabs/currency-tabs'),
  FooterTab: require('./tabs/footer-tab'),
  FooterTabs: require('./tabs/footer-tabs'),
